...
Contributors: Lukasz, Rafal (Elastic Email Inc.)
Donate link: https://elasticemail.com/
Tags:  REST API, elastic email, email, marketing, email marketing, sign-up forms, woocommerce, contact form 7, elastic email integration
...
== Screenshots ==
1. Install Elastic Email for WordPress with ease. Just fill in a few details and let us help you send better emails!
2. If you are looking for the Elastic Email API Key which will be needed during the ElasticEmail for WordPress plugin installation, please go to your Elastic Email account Settings.
3. Review your campaigns and use our detailed reports to analyze your delivery.

== Upgrade Notice ==
= 1.0 =
Dend email using REST API (via Elastic Email) instead of SMTP.


== Changelog ==
= 1.0 =
* Send email using REST API (via Elastic Email)
