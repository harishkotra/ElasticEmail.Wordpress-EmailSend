                        ...
                        <td>
                            ...
                            if (isset($accountstatus)) {
                                if ($accountstatus === 1) {
                                    ...
                                    $accountstatusname = '<span class="ee_account-status-deactive">Please conect to Elastic Email API or complete the profile <a href="https://elasticemail.com/account/#/account/profile"> Complete your profile </a> or connect to Elastic Email API to start using the plugin.</span>';
                                }
                            } else {
                                $accountstatusname = '<span class="ee_account-status-deactive">Please conect to Elastic Email API or complete the profile <a href="https://elasticemail.com/account/#/account/profile"> Complete your profile </a> or connect to Elastic Email API to start using the plugin.</span>';
                            }
                        ...
                        <td>
                            ...
                            if (isset($accountdailysendlimit)) {
                                if ($accountdailysendlimit === 0) {
                                    $accountlimitspan = '<span class="ee_standard-account">No limits</span>';
                                ...
                                if ($accountdailysendlimit === 5 || $accountdailysendlimit === -5) {
                                    ...
                                    $tooltip = 'Oops! It seems your limit is 5. Fill out your profile to get unlimited possibilities.';
                                }
                                if ($accountdailysendlimit == 50 || $accountdailysendlimit === 50) {
                                    $accountlimitspan = '<span class="ee_standard-account">50</span>';
                                    $tooltip = 'Ups! It seems your your limit is 50. Fill out your profile to get unlimited possibilities.';
                                }
                                ...
                                if ($accountdailysendlimit != 0 && $accountdailysendlimit != 5 && $accountdailysendlimit != -5 && $accountdailysendlimit != 50 && $accountdailysendlimit != -50 && $accountdailysendlimit != 5000) {
                                    $accountlimitspan = '<span class="ee_standard-account">Custom: ' . $accountdailysendlimit . '</span>';
                                    $tooltip = 'Your account has a custom limit: ' . $accountdailysendlimit;
                                }
                            } else {
                                $accountlimit = '';
                                $accountlimitspan = ' -------';
